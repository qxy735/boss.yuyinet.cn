...
class SonMenuController extends BaseController
{
    /**
     * 定义网站菜单类型
     *
    ...
    public function listAction()
    {
        ...
        try {
            ...
            // 判断父菜单 ID 是否有效
            if (!$parentId) {
                return $this->error('上级菜单ID无效', "/menu/list/navid/{$navId}");
            }
            ...
            // 获取顶级菜单名称
            $topMenu = Menu::findFirst($parentId);

            // 判断顶级菜单是否存在
            if (!$topMenu) {
                return $this->error('顶级菜单不存在', "/menu/list/navid/{$navId}");
            }
            ...
            // 获取网站菜单信息
            $menus = Menu::find([
                'conditions' => "parentid={$parentId}{$codeSql}{$nameSql}{$typeSql}{$enabledSql} " . 'order by displayorder desc,id desc',
            ...
            $this->view->topMenuName = $topMenuName;
            ...
            return $this->view->pick('sonmenu/list');
        } catch (Exception $e) {
            // 记录错误日志信息
            Log::error($e);

            // 返回错误提示信息
            return $this->error('子菜单信息获取失败', "/menu/list/navid/{$navId}");
        }
    }
    ...
    public function disabledAction()
    {
        ...
        try {
            ...
            if ($menu) {
                ...
                // 判断更新是否成功
                if (!$result) {
                    return $this->error('菜单禁用失败', "/sonmenu/list/parentid/{$parentId}{$cond}");
                }
            }

            return $this->success('菜单禁用成功', "/sonmenu/list/parentid/{$parentId}{$cond}");
        } catch (Exception $e) {
            // 记录错误日志信息
            Log::error($e);
    ...
    public function enabledAction()
    {
        ...
        try {
            ...
            if ($menu) {
                ...
                // 判断更新是否成功
                if (!$result) {
                    return $this->error('菜单启用失败', "/sonmenu/list/parentid/{$parentId}{$cond}");
                }
            }

            return $this->success('菜单启用成功', "/sonmenu/list/parentid/{$parentId}{$cond}");
        } catch (Exception $e) {
            // 记录错误日志信息
            Log::error($e);
    ...
    public function deleteAction()
    {
        ...
        try {
            ...
            // 判断是否存在关联关系
            if ($isRelation) {
                return $this->error('菜单存在关联数据,不允许删除', "/sonmenu/list/parentid/{$parentId}{$cond}");
            }

            // 判断删除是否成功
            if ($isFailed) {
                return $this->error('网站菜单删除失败', "/sonmenu/list/parentid/{$parentId}{$cond}");
            }

            return $this->success('菜单删除成功', "/sonmenu/list/parentid/{$parentId}{$cond}");
        } catch (Exception $e) {
            // 记录错误日志信息
            Log::error($e);
    ...
    public function editAction()
    {
        ...
        try {
            ...
            // 判断菜单信息是否存在
            if (!$menu) {
                return $this->error('菜单不存在', "/sonmenu/list/parentid/{$parentId}{$cond}");
            }
            ...
            return $this->view->pick("sonmenu/edit");
        } catch (Exception $e) {
            // 记录错误日志信息
            Log::error($e);

            // 返回错误提示信息
            return $this->error('菜单信息加载失败', "/sonmenu/list/parentid/{$parentId}{$cond}");
        }
    }
    ...
    public function saveAction()
    {
        ...
        try {
            ...
            // 判断菜单信息是否存在
            if (!$menu) {
                return $this->error('菜单信息不存在', "/sonmenu/list/parentid/{$parentId}{$cond}");
            }
            ...
            // 判断更新内容是否全为空
            if (!$posts) {
                return $this->error('更新内容不能全为空', "/sonmenu/edit/parentid/{$parentId}/id/{$id}{$cond}");
            }
            ...
            // 判断更新是否成功
            if (!$result) {
                return $this->error('菜单更新失败', "/sonmenu/edit/parentid/{$parentId}/id/{$id}{$cond}");
            }

            return $this->success('菜单更新成功', "/sonmenu/list/parentid/{$parentId}{$cond}");
        } catch (Exception $e) {
            // 记录错误日志信息
            Log::error($e);
            ...
            if (BaseModel::isSQLStateDuplicateEntry($e)) {
                return $this->error('菜单信息重复', "/sonmenu/edit/parentid/{$parentId}/id/{$id}{$cond}");
            } else {
                return $this->error('菜单更新失败', "/sonmenu/edit/parentid/{$parentId}/id/{$id}{$cond}");
            }
        }
